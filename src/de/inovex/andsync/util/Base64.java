...
public class Base64 {
	...
	private static final Map<Character, Byte> map = new ConcurrentHashMap<Character, Byte>();
	 ...
	 * 
	 * @param in A string to encode.
	 * @param lineBreak The amount of characters on each line or 0 for no line breaks.
	 * @return The encoded byte array.
	 */
	public static String encode(byte[] in, int lineBreak) {
		...
		for (int i = 0; i < encoded.length; i++) {
			...
			if (lineBreak > 0 && i % lineBreak == lineBreak - 1) {
				builder.append("\n");
			}
		}
